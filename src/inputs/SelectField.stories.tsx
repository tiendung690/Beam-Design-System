...
export function PerfTest() {
  const [selectedValue, setSelectedValue] = useState<TestOption>(loadTestOptions[2]);

  return (
    <SelectField
      label="Project"
      selectedOption={selectedValue}
      onSelect={(_, o) => setSelectedValue(o)}
      errorMsg={selectedValue !== undefined ? "" : "Select an option. Plus more error text to force it to wrap."}
      options={async () => loadTestOptions}
...
// ): JSX.Element {
//   const [selectedValue, setSelectedValue] = useState<V | undefined>(props.value);
//
//   return (
//     <div css={Css.df.$}>
//       <SelectField<T, V>
...
//         errorMsg={
//           selectedValue !== undefined || props.disabled
//             ? ""
...
//         onFocus={action("onFocus")}
//       />
//       <div css={Css.m3.$}>value={selectedValue}</div>
//     </div>
//   );
// }
